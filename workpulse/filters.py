...
TRANSLATIONS = {
    'en': {
        ...
        'active_status': 'Active (On Job)',
        'terminated_status': 'Terminated / Departed',
        'basic_salary': 'Basic Salary',
        'total_salary': 'Total Salary',
        'daily_basic': 'Daily Basic Wage',
        'daily_total': 'Daily Total Wage',
        'net_settlement': 'Net Final Settlement',
        'gratuity': 'End of Service Gratuity',
        'leave_encashment': 'Annual Leave Encashment',
        'additions': 'Financial Additions',
        ...
        'export_all_excel': 'Export Comprehensive Excel Report',
        'print_settlement': 'Print Settlement Slip',
        'termination_date': 'Termination Date / Last Day'
    },
    'ar': {
        ...
        'end_of_service': 'تصفية نهاية الخدمة',
        'active_status': 'على رأس العمل',
        'terminated_status': 'منتهي الخدمة',
        'basic_salary': 'الراتب الأساسي',
        'total_salary': 'الراتب الشامل',
        'daily_basic': 'أجر اليوم الأساسي',
        'daily_total': 'أجر اليوم الشامل',
        'net_settlement': 'صافي مستحقات التصفية',
        'gratuity': 'مكافأة نهاية الخدمة',
        'leave_encashment': 'بدل الإجازات السنوية',
        'additions': 'الإضافات المالية',
        'deductions': 'الخصومات المالية',
        'leave_requests': 'طلبات الإجازات',
        'request_leave': 'تقديم طلب إجازة',
        'annual_leave': 'إجازة سنوية',
        'sick_leave': 'إجازة مرضية',
        'parental_leave': 'إجازة الوالدية',
        'bereavement_leave': 'إجازة الحداد',
        'unpaid_leave': 'إجازة بدون راتب',
        'export_all_excel': 'تحميل ملف إكسل الشامل للموظفين',
        'print_settlement': 'طباعة كشف التصفية',
        'termination_date': 'تاريخ التصفية / آخر يوم'
    }
}
